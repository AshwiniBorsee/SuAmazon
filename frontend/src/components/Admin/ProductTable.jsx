            ...
            renderCell: (params) => {
                return (
                    <>
                        {
                            params.row.stock < 10 ? (
                                <span className="font-medium text-black p-1 w-6 h-6 flex items-center justify-center">{params.row.stock}</span>
                            ) : (
    ...
    return (
        <>
            ...
            <div className="flex justify-between items-center">
                ...
                <Link to="/admin/new_product" className="py-2 px-2 rounded shadow font-medium text-black hover:shadow-lg">New Product</Link>
            </div>
            <div className="bg-grey rounded shadow-lg w-full" style={{ height: 470 }}>
