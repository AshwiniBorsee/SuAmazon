...
const Shipping = () => {
    ...
    const shippingSubmit = (e) => {
        ...
        dispatch(storeShippingInfo({ address, city, country, state, pincode, phoneNo }));
                        ...
                        <Stepper activeStep={1}>
                            <div className="w-full bg-white">
                                ...
                                <form onSubmit={shippingSubmit} autoComplete="off" className="flex flex-col justify-start gap-3 w-full sm:w-3/4 mx-1 sm:mx-8 my-4">
                                    ...
                                    <button type="submit" className="bg-pink-600 w-60 sm:w-1/3 my-2 py-3.5 text-sm font-medium text-white shadow hover:shadow-lg rounded-sm uppercase outline-none">Deliver Here</button>
                                </form>
                            </div>
                        </Stepper>
                    </div>
