...
//                             <button onClick={() => { navigate('/process/payment') }} className="bg-pink-400 px-6 py-2 text-white font-medium rounded-sm shadow hover:shadow-lg uppercase">continue</button>
//                         </div>
//                     </Stepper>
//                 </div>
