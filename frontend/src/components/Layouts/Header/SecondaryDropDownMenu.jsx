    ...
    const navs = [
        {
            ...
            redirect: "https://www.Ecommerce.com/communication-preferences/push",
        },
        {
            title: "Sell on Ecommerce",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.Ecommerce.com/sell-online",
        },
        {
            title: "24x7 Customer Care",
            icon: <LiveHelpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.Ecommerce.com/helpcentre",
        },
        {
            title: "Advertise",
            icon: <TrendingUpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://advertising.Ecommerce.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.Ecommerce.com/mobile-apps",
        },
    ]
